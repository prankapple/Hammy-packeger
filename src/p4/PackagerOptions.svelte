...
>
  <div>
    ...
    <!-- svelte-ignore a11y-label-has-associated-control -->
    <label class="option">
      <input type="checkbox" bind:checked={$options.Blox.permissionManager.enabled}>
      Enable permission manager
    </label>
    <p>The permission manager in Blox is the prompts that appear when asking for permission to do something. You can disable it if the permission manager doesn't work in your case, or is causing annoying pop-ups constantly throughout your project.</p>
  </div>
</Section>
